                        ...
                        <Stack>
                            <Group grow spacing={5}>
                                <Stack spacing={5}>
                                    ...
                                    <Paper style={{ width: '100%', backgroundColor: '#2e3036', borderRadius: 5, textAlign: 'center' }} >
                                        <Text fz="md">{lang.GarageMenu4}</Text>
                                        <Text fz="xs" fw={700} c="teal.4">{vehicle.mileage}</Text>
                                    </Paper>

                                </Stack>
                                <Stack spacing={5} justify="flex-start" h={99}>
                                    <Button onClick={SpawnVehicle} disabled={vehicle.stored == 0} leftIcon={<IconCarGarage size={17} />} variant="light" size='xs' >{lang.GarageMenu5}</Button>
                                    {vehicle.isOwner && (<>
