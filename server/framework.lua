...
local query = {
    ['esx'] = {
        ...
        queryImpound = 'UPDATE `owned_vehicles` SET `parking` = ?, `stored` = 0, `pound` = 1, `coords` = NULL, metadata = ? WHERE `plate` = ?'
    },
    ...
    ['qbox'] = {
        ...
        queryImpound = 'UPDATE `player_vehicles` SET `garage` = ?, `stored` = 0, `pound` = 1, `coords` = NULL, metadata = ? WHERE `plate` = ?'
    },
