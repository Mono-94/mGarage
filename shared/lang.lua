Text = {
    ...
    ['HU'] = {
        -- UI
        GarageName = "Garázs Név",
        GarageCreateSpan = "Egyéni Garázs név",
        GarageJob = "Munka",
        GarageJobSpan = "Ha üresen van hagyva, mindenkinek van",
        GarageType = "Garage Type",
        GarageTypeSpan = "Típus választás, 2 opció van: Garázs / Lefoglaltak",
        GarageType1 = "Garázs",
        GarageType2 = "Lefoglaltak",
        GarageType3 = "Saját",
        GarageImpound = "Lefoglaltak ára",
        GarageImpoundSpan = "Írj be egy alap árat a kocsik kivételére a lefoglaltakbol",
        GarageSociety = "Frakció",
        GarageSocietySpan = "Frakció neve ahova fognak menni a kocsik",
        GarageActionType = "Zóna típus",
        GarageActionTypeSpan = "TextUI / Target / Radial Menu",
        GarageActionType1 = "Target",
        GarageActionType2 = "TextUI",
        GarageActionType3 = "Radial Menu",
        GarageNPC = "NPC Hash",
        GarageNPCSpan = "Adj egy NPCt a zónába, működik a garázs koordinátákkal",
        GarageVehicleType = "Jármű Típus",
        GarageVehicleTypeSpan = "Válaszd ki a jármű típusokat amiket ide le lehet parkolni",
        GarageDebug = "Debug",
        GarageDebugSpan = "Zóna Debug",
        GarageInTocar = "Kocsiba teleportálás",
        GarageInTocarSpan = "Játékos kocsiba helyezése amikor kiveszi a kocsit",
        GarageBlip = "Blip",
        GarageBlipSpan = "Garázs blip ki / be kapcsolása",
        GarageCustomCars = "Saját járművek",
        GarageCustomCarsSpan = "Válasz egy pár alap kocsit, csak kocsik ebből a garázsbol menhetőek",
        GarageRentACar = "Jármű Bérlés",
        GarageRentACarSpan = "Állítsd be az árat a jármű bérléséhez",
        GarageSharedVehicles = "Kevert Garázs",
        GarageSharedVehiclesSpan = "Nézd meg az összes kocsit a játékos tulajdonságába",
        GarageDefaultImpound = "Alap Lefoglaltak",
        GarageDefaultImpoundSpan = "Állíts be egy lefoglaltakat ahol vissza lehet szerezni a kocsikat",
        GaragePayMethod = "Fizetési Mód",
        GaragePayMethodMoney = "Készpénz",
        GaragePayMethodBank = "Bank",
        GarageButton1 = "Koordináták",
        GarageButton2 = "Zóna Beállítás",
        GarageButton3 = "Lehívás Koordináták",
        GarageButton4 = "Garázs Létrehozása",
        GarageButton5 = "Teleportálás",
        GarageButton6 = "Frissítés",
        GarageButton7 = "Törlés",
        GarageButton8 = "Garázsok Lista",
        GarageMenu1 = "Ár:",
        GarageMenu2 = "Dátum:",
        GarageMenu3 = "Fizetés és visszakapás",
        GarageMenu4 = "Kilométerállás",
        GarageMenu5 = "Kivétel",
        GarageMenu6 = "Kulcsok",
        GarageMenu7 = "GPS",
        GarageMenu9 = "Benzin",
        GarageMenu10 = "Motor",
        GarageMenu11 = "Karosszéria",
        GarageMenu12 = "GPS",
        -- New Lines
        GarageMenu13 = "Rendszámtábla prefix",
        GarageMenu14 = "Állíts be egy prefix-et ami maximum 4 Karakterből áll, amit ez a garázs fog használni",
        GarageMenu15 = "Jármű Típus",
        GarageMenu16 = "Ár / Óra",
        GarageMenu17 = "Grade választása a kocsinak",



        -- Notifications
        notYourVehicle = 'Ez a jármű nem a tiéd!',
        impound1 = 'Fizettél %s$ a kocsidért!',
        impound2 = 'Nincsen elég pénzed hogy a járműved visszaszerezd',
        impound3 = '',
        noSpawnPos = 'Nincsen elérhető lehívó pont!',
        setBlip = 'Kocsi megjelölve a térképen!',
        noVehicles = 'Nincsen kocsid a garázsba!',

        --Target
        TargetSaveCar = 'Jármű eltárolása',
        TargetImpound = 'Jármű lefoglaltakba küldése',

        -- Impound
        ImpoundOption1 = 'Kocsi lefoglaltakba küldése',
        ImpoundOption2 = 'Ok',
        ImpoundOption3 = 'Kivétel Ára',
        ImpoundOption4 = 'Minimum idő beállítása',
        ImpoundOption5 = 'Idő',
        ImpoundOption6 = 'Rendszámtábla',
        ImpoundOption7 = 'Járműnek a megállítási dátuma visszavonása',
        ImpoundOption8 = 'Ennek a kocsinak nincsen megállítási dátuma',
        ImpoundOption9 = 'Ez a kocsi nincsen lefoglalva!',
        ImpoundOption10 = 'Ennek a kocsinak a rendszámtáblája %s nincsen regisztrálva!',
        ImpoundOption11 = 'Tönkretevés Visszavonása!',
        ImpoundOption12 = "Ezt a kocsit vissza fogod tudni kapni.",
        ImpoundOption13 = "Hátramaradt lefoglaltakban lévő idő  \n  **%s napok, %s órák, %s perc**",
        ImpoundOption14 = "Lefoglalás",

        --Admin Zone
        GarageCreate1 = 'mGarage CREATE',
        GarageCreate2 = 'mGarage DELETE',
        GarageCreate3 = 'mGarage UPDATE',
        GarageCreate4 = 'Duplikált Garázs [ %s ] Név.',
        GarageCreate5 = 'Garázs %s Sikeresen Létrehozva',
        GarageCreate6 = 'Garázs sikeresen törölve',
        GarageCreate7 = 'Garázs sikeresen frissítve',
        TextUiCreateZone =
        '[MB1] + Point   \n  [MB2] Utolsó pont törlése   \n  [SCROLL] Magasság  \n  [ENTER] Zóna Mentése  \n  [BACKSPACE] Bezárás ',
        TextUiCoords =
        '[E] +Coords  \n  [SCROLL] Irány  \n  [BACKSPACE] Utolsó koordináták tölrése  \n  [G] None/Player/Vehicle  \n  [ENTER] koordináták mentése'
    },
}
